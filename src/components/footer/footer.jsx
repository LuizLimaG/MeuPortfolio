...
export default function Footer() {
  return (
    <footer className="w-full h-20 bg-darkPurple rounded-lg shadow-neonPurple flex flex-col-reverse justify-center items-center gap-2 sm:flex-row sm:px-20 sm:gap-0">
